...
func (m *middleware) checkRolePrecedence(ctx context.Context, user *users.User, roleName string) (bool, error) {
...
func (m *middleware) getUser(ctx context.Context, userID int64) (*users.User, error) {
	// get user from cache
